...
function multiplyArray(multArr) { //eslint-disable-line
  var arrayProd = multiply(multiply(multArr[0], multArr[1])[0], multArr[2])[0];
  var arrayMessage = 'The numbers ' + multArr[0] + ',' + multArr[1] + ',' + multArr[2] + ' have a product of ' + arrayProd + '.';
  //   console.log(arrayMessage);
  return [arrayProd, arrayMessage];
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  //   console.log(output);
  message += ' have a product of ' + output + '.';
  //   console.log(message);
  return [output, message];
}
